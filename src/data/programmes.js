...
export const PROGRAMMES = {
  ...
  maintain_and_build: {
    ...
    name: 'Maintain & Build',
    for_user: 'husband',
    description: 'Calisthenics-first home training. Push / Pull / Legs. 2–3 days/week.',
    days_per_week: [2, 3],
        ...
        exercises: [
          {
            ...
            reps_min: 6,
            reps_max: 15,
            note: 'Progress: standard → wide → archer → pseudo planche. Add reps before changing variation.',
          },
          {
            ...
            reps_min: 6,
            reps_max: 12,
            note: 'Shoulders. Progress to wall handstand push-up over time.',
          },
          {
            exercise_id: 'dip',
            sets: 3,
            reps_min: 8,
            reps_max: 15,
            note: 'Chair or sofa. Elbows back, not flared.',
          },
          {
            exercise_id: 'push_up',
            sets: 2,
            reps_min: 8,
            reps_max: 12,
            note: 'Diamond grip — triceps focus. Hands form a triangle.',
          },
          { exercise_id: 'plank', sets: 3, hold_secs: 30, hold_max: 60 },
        ],
        mobility_addon: true,
        ...
        exercises: [
          {
            ...
            reps_min: 3,
            reps_max: 10,
            note: 'No bar? Use bent-over row with heaviest available weight. Pull-up is the goal.',
          },
          { exercise_id: 'bent_over_row', sets: 3, reps_min: 8, reps_max: 12 },
          {
            exercise_id: 'pull_up',
            ...
            reps_min: 3,
            reps_max: 8,
            note: 'Close grip (chin-up style) — more bicep. Same movement pattern.',
          },
          { exercise_id: 'dead_bug', sets: 3, reps_min: 8, reps_max: 10, per_side: true },
        ...
        exercises: [
          {
            ...
            reps_min: 10,
            reps_max: 20,
            note: 'Progress: bodyweight → jump squat → pistol squat assisted → pistol squat.',
          },
          {
            ...
            reps_min: 8,
            reps_max: 12,
            note: 'Use heaviest available weight. Or single-leg hip hinge if no weights.',
          },
          { exercise_id: 'reverse_lunge', sets: 3, reps_min: 8, reps_max: 12, per_side: true },
          {
            exercise_id: 'hip_thrust',
            sets: 3,
            reps_min: 12,
            reps_max: 20,
            note: 'Bodyweight or weighted. Shoulders on sofa/bed.',
          },
          { exercise_id: 'dead_bug', sets: 3, reps_min: 8, reps_max: 10, per_side: true },
          { exercise_id: 'plank', sets: 3, hold_secs: 30, hold_max: 60 },
        ],
